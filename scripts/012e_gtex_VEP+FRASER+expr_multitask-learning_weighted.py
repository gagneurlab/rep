...
CURRENT_MODEL_DIR="VEP+MMSplice+expr-multitask_weighted"
...
# ## Load FRASER features

fraser = xr.open_zarr(os.path.join(PROCESSED_DATA_DIR, "gtex", "FRASER", "agg_gene.zarr"))
fraser

fraser_stacked = fraser.stack(observations=["individual", "gene"], features=["end", "subtissue"])
fraser_stacked
...
features = concat_by_axis([
    ...
    blood.normppf.expand_dims({"features": ["zscore"]}, axis=-1), 
